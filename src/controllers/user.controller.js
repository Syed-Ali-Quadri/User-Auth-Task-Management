...
const loginUser = AsyncHandler(async (req, res) => {
    ...
    .json(new ApiResponse(200, { user: logginUser, AccessToken, RefreshToken }, "User successfully logged in.")); // Custom API response with tokens and user details
})

// Export both the registerUser and loginUser functions for use in routes
